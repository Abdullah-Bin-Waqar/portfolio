...
const tech = ['React', 'Node.js', 'Express', 'MongoDB', 'Python', 'TensorFlow'];
      ...
      <section className='grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center'>
        <div className='space-y-8'>
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='max-w-2xl text-lg leading-8 text-slate-600'>
            Aspiring AI Engineer with strong expertise in Machine Learning, Deep Learning, Computer Vision, Data Analysis, and Generative AI. Experienced in developing AI powered solutions, data-driven applications, and educational technology systems.
          </motion.p>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.9 }} className='flex flex-col gap-4 sm:flex-row sm:flex-wrap'>
            <a href='/contact' className='btn-primary w-full sm:w-auto'>Hire me</a>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} className='relative flex items-center justify-center overflow-visible p-0'>
